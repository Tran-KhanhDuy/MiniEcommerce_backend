...
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.ENUM(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.USER),
        allowNull: false,
...
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => products_model_1.Products),
